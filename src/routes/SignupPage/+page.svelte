...
<script lang="ts">
    ...
    let name = '';
    let surname = '';
    // Add a state for the photo here if you plan to upload it to Supabase storage.
    ...
    const handleRegister = async () => {
      ...
      try {
        ...
        // If registration is successful, you can save the additional user details in the database.
  ...
  <main>
    ...
    <form on:submit|preventDefault={handleRegister} class="form1">
            <div class="items1">
                ...
                <!-- bind:this={photo_url}  -->
                <button type="button" id="custom-button">Add photo</button>
